...
-- -----------------------------------------------------
CREATE TABLE "mydb"."livros_has_pessoa" (
  "isbn" INT NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE "mydb"."autor_has_livros" (
...
VALUES (80222520884,'Carlos Duarte', 'carlos.duarte@gmail.com', 'Brasil','Masculino','02-02-1982')
       ...
       (96352539076,'Pietra Silva','pietraa123@gmail.com', 'Brasil','França','Feminino','11-03-2000')
       (07868915722,'Nicole Freutas','freitasnicole@gmail.com','Portugal')